...
SOURCES: list[tuple[str, str]] = [
    ...
    # Independent broker wire types must be available before the platform
    # package can resolve, even though this dependency is optional.
    (
        "crates/running-process-platform-internal/Cargo.toml",
        r'^running-process-protocol\s*=\s*\{[^}]*version\s*=\s*"=?([^"]+)"',
    ),
