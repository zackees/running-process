...
STAGES: dict[str, str] = {
    ...
    "test-frame-v1-codec": "ci.frame_v1_codec_e2e",
    "guard-daemon-registration": "ci.daemon_registration_contract",
    "test-daemon-registration": "ci.daemon_registration_e2e",
    "guard-daemon-registration-v2": "ci.daemon_registration_v2_contract",
    "test-daemon-registration-v2": "ci.daemon_registration_v2_e2e",
