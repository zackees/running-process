...
use crate::daemon_registration::protocol::{BrokerIsolation, ServiceDefinition};
use crate::daemon_registration::validation::{validate_service_name, validate_version};
pub use crate::daemon_registration_common::service_definition::{
...
fn ensure_loadable_service_definition_dir(path: &Path) -> Result<(), ServiceDefinitionError> {
    if !crate::daemon_registration_common::secure_dir::private_dir_permissions_are_private(path)? {
